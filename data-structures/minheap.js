/**
 * Creates a Min Heap Data Structure and provide push and pop methods
 * @param {Array} list List of elements to initialize the heap with
 */
const MinHeap = function(list) {
	...
	/**
	 * Removes the top element from the heap (returns the smallest element from the heap)
	 */
	this.pop = function() {
		if(this.empty())
		...
		/**
		 * Replace the element with smallest of its two children until it is larger than any of its children
		 */
